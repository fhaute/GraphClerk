...
from app.schemas.retrieval_packet import ContextBudgetSummary, InterpretedIntent, RetrievalPacket, SelectedSemanticIndex
...
@pytest.mark.asyncio
async def test_retrieve_api_actor_context_recording_and_retrieval_parity(db_ready: None, monkeypatch) -> None:
    app = create_app()
    ...
    async with httpx.AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        res_bad = await client.post("/retrieve", json={"question": "ok", "actor_context": {"actor_id": ""}})
