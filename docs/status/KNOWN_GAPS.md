...
- **Phase 8 audit**: **`pass_with_notes`** — [`docs/audits/PHASE_8_AUDIT.md`](../audits/PHASE_8_AUDIT.md) (**2026-05-03**); historical baseline — **full-completion audit** (**D8**), **writable** operator selector / admin UI (**D7b**), and **`openai_compatible`** adapter (**D3b**) remain gaps.
...
- **Writable frontend selector / admin persistence for model purposes**: **not implemented** (**D7b**).
