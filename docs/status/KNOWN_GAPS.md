...
- **Phase 8 audit**: **`pass_with_notes`** — [`docs/audits/PHASE_8_AUDIT.md`](../audits/PHASE_8_AUDIT.md) (**2026-05-03**); accepts baseline only — ingestion merge, **D5** orchestration wiring, and operator UI remain gaps beyond **D2**–**D4** contracts.
