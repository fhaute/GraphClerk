...
- **Phase 8 audit**: **`pass_with_notes`** — [`docs/audits/PHASE_8_AUDIT.md`](../audits/PHASE_8_AUDIT.md) (**2026-05-03**); historical baseline — **full-completion audit**, operator selector UI, and **`openai_compatible`** adapter remain gaps (**Track D D7+ / D3b / D8**).
...
- **Frontend selector / operator UI for model purposes**: **not implemented** (**D7**).
