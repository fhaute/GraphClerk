...
| **Missing work** | **Track D D7+**: frontend / operator visibility + selector (**D7**); optional **OpenAI-compatible** adapter (**D3b**); **Phase 8 full-completion audit** (**D8**). |
